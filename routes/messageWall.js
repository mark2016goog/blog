...
//添加留言
router.post('/message', base.loginGo, async function(ctx, next){
...
//编辑留言
router.post('/editMessage', base.loginGo, async function(ctx, next){
...
//删除留言
router.post('/deleteMessage', base.loginGo, async function(ctx, next){
	try {
...
//删除评论
router.post('/deleteComment', base.loginGo, async function(ctx, next){
	try {
